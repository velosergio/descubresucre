...
- [ ] T010 [P] Define security baseline tasks (input validation, auth/authz checks, secret handling)
- [ ] T011 [P] Define observability baseline tasks (critical logs, metrics/traces where needed)
...
### Tests for User Story 1 (REQUIRED when risk/criticality demands) ⚠️
...
- [ ] T018 [US1] Add input validation, auth/authz checks, and error handling
- [ ] T019 [US1] Add structured logging and telemetry for critical operations
...
### Tests for User Story 2 (REQUIRED when risk/criticality demands) ⚠️
...
- [ ] T026 [US2] Confirm security controls and observability coverage for this story
...
### Tests for User Story 3 (REQUIRED when risk/criticality demands) ⚠️
...
- [ ] T032 [US3] Confirm security controls and observability coverage for this story
...
- [ ] TXXX [P] Additional unit/integration tests to close risk gaps in tests/
- [ ] TXXX Security hardening
- [ ] TXXX Validate logging/monitoring dashboards and alerting signals
...
- Tests MUST be written and FAIL before implementation when required by risk
...
- Include explicit tasks for security and observability where the story has
  external input, auth/authz, or operational risk

...
import { type ClassNames, DayFlag, DayPicker, SelectionState, UI } from "react-day-picker";
    ...
    <DayPicker
      ...
      components={{
        Chevron: ({ className: chevronClassName, orientation, ...chevronProps }) => {
          const classNamesMerged = cn("h-4 w-4", chevronClassName);
          if (orientation === "left") {
            return <ChevronLeft className={classNamesMerged} {...chevronProps} />;
          }
          if (orientation === "right") {
            return <ChevronRight className={classNamesMerged} {...chevronProps} />;
          }
          if (orientation === "down") {
            return <ChevronDown className={classNamesMerged} {...chevronProps} />;
          }
          return <ChevronUp className={classNamesMerged} {...chevronProps} />;
        },
        ...components,
      }}
      {...props}

...
import { BookOpen, Music, Paintbrush, Theater } from "lucide-react";

const agendaItems = [
  {
    day: "5",
    month: "Mar",
    title: "Concierto de Gaitas y Tambores",
    category: "Música",
    icon: Music,
    location: "Plaza Cultural, Sincelejo",
  },
  {
    day: "8",
    month: "Mar",
    title: "Exposición Artesanal Zenú",
    category: "Arte",
    icon: Paintbrush,
  ...
  },
  {
    day: "12",
    month: "Mar",
    title: "Teatro Comunitario: Raíces",
    category: "Teatro",
    icon: Theater,
    location: "Casa de la Cultura, Sincelejo",
  },
  {
    day: "15",
    month: "Mar",
    title: "Feria del Libro Caribeño",
    category: "Literatura",
    icon: BookOpen,
    location: "Biblioteca Departamental",
  },
  {
    day: "18",
    month: "Mar",
    title: "Noche de Porros y Fandangos",
    category: "Música",
    icon: Music,
    location: "Parque Santander, Sincelejo",
  },
  {
    day: "22",
    month: "Mar",
    title: "Muestra de Cine Regional",
    category: "Arte",
    icon: Paintbrush,
  ...
  },
  {
    day: "25",
    month: "Mar",
    title: "Taller de Hamacas Tradicionales",
    category: "Arte",
    icon: Paintbrush,
  ...
  },
  {
    day: "29",
    month: "Mar",
    title: "Festival de Decimeros",
    category: "Literatura",
    icon: BookOpen,
    location: "Ovejas, Sucre",
  },
];
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0">
                  <span
                    className={`inline-block text-xs font-body font-medium rounded-full px-2 py-0.5 mb-1.5 ${categoryColors[item.category]}`}
                  >
                    {item.category}
                  </span>
